...
<header>
  ...
  <div>
    ...
    <div class="version">v1.3.0 · AI OS Command Center</div>
  </div>
...
<main>
  ...
  <div class="card" id="card-os">
    ...
    <div class="metric-row">
      ...
      <span class="metric-value" id="os-version">1.3.0</span>
    </div>
    <div class="metric-row">
...
<footer>AURa v1.3.0 · Free &amp; Open Source · Built with ❤️ by the AURa Project</footer>
...
<script>
  async function fetchMetrics() {
    try {
      ...
      // OS
      document.getElementById('os-version').textContent = d.version || '1.3.0';
